...
urlpatterns = [
    ...
    path('api/<int:pk>', views.EmployeeRetrieveUpdateDestroyModelMixinView.as_view()),
    # path('api/', views.EmployeeListCreateAPIView.as_view()),
    path('api/', views.EmployeeListCreateModelMixinView.as_view()),
]
